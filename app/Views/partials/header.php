				...
				<div class="navbar-header">
					<div class="row">
						...
						<div id="logo" class="col-xs-4 col-sm-4" >
							<a href="<?php echo $this->url('librairie_accueil'); ?>"><img class="img-responsive" src="<?php echo $this->assetUrl('img/commun/logoLibrairie.png')?>" alt="logo-librairie-a-la-gloire-de-mon-pere-Mazan"></a>
						</div>
